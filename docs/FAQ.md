...
# 安装计划任务（5 分钟自动检测恢复）
schtasks /Create /TN "PMP-Athena-Bridge" /SC MINUTE /MO 5 /TR 'conhost.exe --headless powershell.exe -NoProfile -NonInteractive -ExecutionPolicy Bypass -WindowStyle Hidden -File "D:\pmp-athena\bridge_guard.ps1"' /IT /F
```
